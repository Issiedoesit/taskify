    ...
    return (
        <button type='button' aria-label={ariaLabel} title={title} onClick={()=>copy(text)} className="relative group cursor-pointer flex flex-row justify-center items-center bg-brandDashGray24x rounded-fiftyPercent">
            <svg width="42" height="41" viewBox="0 0 42 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.9441 21.0328V24.2995C23.9441 27.0217 22.8552 28.1106 20.133 28.1106H16.8663C14.1441 28.1106 13.0552 27.0217 13.0552 24.2995V21.0328C13.0552 18.3106 14.1441 17.2217 16.8663 17.2217H20.133C22.8552 17.2217 23.9441 18.3106 23.9441 21.0328Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path opacity="0.4" d="M28.6106 16.3663V19.633C28.6106 22.3552 27.5217 23.4441 24.7995 23.4441H23.9439V21.033C23.9439 18.3107 22.855 17.2218 20.1328 17.2218H17.7217V16.3663C17.7217 13.6441 18.8106 12.5552 21.5328 12.5552H24.7995C27.5217 12.5552 28.6106 13.6441 28.6106 16.3663Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
