...
const OverviewChart = ({year, overviewData}) => {
        ...
        datasets: [
          {
            ...
            borderColor: "#E2E2E2",
            data: [
                overviewData ? overviewData['sunday'] : 0, 
                overviewData ? overviewData['monday'] : 0, 
                overviewData ? overviewData['tuesday'] : 0, 
                overviewData ? overviewData['wednesday'] : 0, 
                overviewData ? overviewData['thursday'] : 0, 
                overviewData ? overviewData['friday'] : 0, 
                overviewData ? overviewData['saturday'] : 0
            ],
          },
        ]
      };
  ...
  return (
    <div className="px-6 py-6 rounded-thirty flex flex-col justify-between gap-10 self-stretch w-full border border-transparent bg-white">
        ...
        <div className='' id="overviewChart" >
