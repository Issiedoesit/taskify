            ...
            <td className="capitalize py-4 px-4 whitespace-nowrap">
                <div className='flex items-center gap-3 pr-4'>
                {
                        avatar
                            ...
                            :
                            <div className={`w-8 h-8 rounded-full aspect-square flex items-center justify-center bg-brandBlue1x/50`}>
                ...
                <div className='flex items-center gap-3 pr-4'>
                    {
                        creator?.profile_photo
                            ?
                            <img src={creator?.profile_photo} alt={name} className={'w-8 h-8 min-w-8 aspect-square rounded-full skeleton'} />
